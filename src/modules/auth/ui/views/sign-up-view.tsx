...
export default function SignUpView({
  ...
  const showPreviewStore = username && !usernameError;
              ...
              <div className='flex flex-col gap-6'>
                <div className='flex flex-col items-center text-center'>
                  ...
                  <p className='text-muted-foreground text-sm text-balance'>
                    Join over 100,000+ creators earning money with Funroad.
                  </p>
                </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription
                          className={cn(
                            'hidden text-xs text-balance md:text-sm',
                            showPreviewStore && 'block'
                          )}
                        >
                          Your store will be available at{' '}
                          <span className='font-medium'>
                            {field.value}.funroad.com
                          </span>
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
