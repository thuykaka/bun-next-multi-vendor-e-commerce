...
export interface Tenant {
  ...
  name: string;
  /**
   * The subdomain of the store (e.g. "john-doe.funroad.com")
   */
  slug: string;
  /**
  ...
  /**
   * The Stripe account ID of the store
   */
...
export interface Product {
  ...
  refundPolicy?: ('1-day' | '3-days' | '7-days' | '14-days' | '30-days' | 'no-refund') | null;
  ...
  /**
   * If checked, the product will not be visible to customers.
   */
